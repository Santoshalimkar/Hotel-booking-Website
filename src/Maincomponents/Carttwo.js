...
export default function Carttwo() {
  ...
  const fetchHotels = async () => {
    const res = await fetch("http://localhost:2585/Retrive");
  ...
  return (
    <>
      {loading ?(<>
       ...
       {matches?<CardSkeleton sx={{backgroundColor:"#f5f5f5"}}/>:<>
        <CardSkeleton sx={{backgroundColor:"#f5f5f5"}}/>
        <CardSkeleton sx={{backgroundColor:"#f5f5f5"}}/></>}
       </div>
            ...
            <Card sx={{ maxWidth: 600,zIndex:"0",backgroundColor:"#f5f5f5" }}>
              ...
              <CardContent>
                <List sx={{ width: "100%" }}>
                  ...
                  <ListItem disablePadding>
                    <ListItemIcon>
                      <DirectionsIcon sx={{color:"#141729"}} />
                    </ListItemIcon>
                    <ListItemButton>
